...
import { MoreVertical, History, FileText } from 'lucide-vue-next'
...
const emit = defineEmits<{
  viewHistory: [debt: CustomerDebt]
  viewDebts: [debt: CustomerDebt]
...
const paginationInfo = computed(() => {
  if (props.total === 0) return 'Aucune dette client'
        ...
        <TableBody>
          ...
          <template v-else-if="displayedDebts.length > 0">
            ...
            >
              ...
              <TableCell class="text-[14px] font-medium text-[#292D32] text-center" style="font-family: Poppins">
                {{ formatMontant(debt.total_invoiced) }}
              </TableCell>
